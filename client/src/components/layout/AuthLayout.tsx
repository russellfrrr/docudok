        ...
        <div className="w-full max-w-md space-y-8">
          <div className="space-y-10">
            ...
            <div className="space-y-4">
              ...
              <p className="max-w-sm text-[0.96rem] font-normal leading-7 text-muted-foreground">
                {description}
              </p>
            </div>
          </div>
          ...
          <div className="grid gap-3 text-[0.84rem] font-medium leading-6 text-muted-foreground">
            {[
      ...
      <section className="hidden border-l bg-card lg:block">
        <div className="relative flex h-full min-h-screen items-center justify-center overflow-hidden px-10 py-14 xl:px-16">
          ...
          <div className="relative w-full max-w-3xl">
            ...
            <div className="relative overflow-hidden rounded-xl border border-border/80 bg-background shadow-2xl shadow-black/5 dark:shadow-black/30">
              ...
              <div className="border-b bg-card/40 px-6 py-5">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[0.88rem] font-semibold tracking-tight text-foreground">
              ...
              <div className="grid gap-5 p-6">
                ...
                >
                  <div className="mb-3 flex items-center gap-2 text-[0.68rem] font-semibold uppercase tracking-[0.18em] text-sky-700 dark:text-sky-300">
                ...
                <div className="grid gap-2">
                  ...
                  <motion.div
                    className="cursor-pointer rounded-lg border bg-card p-4 text-[0.8rem] leading-6 text-muted-foreground transition hover:border-sky-500/30 hover:bg-muted/40"
            ...
            <div className="mt-6 grid grid-cols-3 gap-3 text-[0.68rem] font-semibold uppercase tracking-[0.14em] text-muted-foreground">
